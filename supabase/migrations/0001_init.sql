...
-- Access model v1: any Discord-authenticated user whose Discord ID is in
...
-- future admin UI). Keyed on the Discord snowflake ID.
...
-- True when the signed-in Discord user is on the allowlist.
-- Discord snowflake arrives in the JWT as user_metadata.provider_id.
